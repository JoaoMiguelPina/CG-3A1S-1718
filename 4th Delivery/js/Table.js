...
var textureTable = new THREE.TextureLoader().load( "textures/textura.png" );
textureTable.wrapS = THREE.RepeatWrapping;
textureTable.wrapT = THREE.RepeatWrapping;
textureTable.repeat.set( 4, 4 );


var materialTableBasic = new THREE.MeshBasicMaterial({color: 0x006FBF , wireframe: true, map: textureTable});

var materialTablePhong = new THREE.MeshPhongMaterial({color: 0x006FBF , wireframe: true, map: textureTable});

var materialTableLambert = new THREE.MeshLambertMaterial({color: 0x006FBF , wireframe: true, map: textureTable});
...
class Table extends GameObject{
	...
	addTableTop(material){
		...
		geometry = new THREE.CubeGeometry(1250, 700, 10,10,10,1);
